...
export default function Servers() {
  ...
  const duties = {
  Opening: [
    "Wipe down all the menus and make sure the inserts aren’t stained or dirty.",
    "Use glass cleaner to clean the fireplace glass and the wine coolers.",
    "Coordinate with AGM or Lead Server to input server sections into OpenTable.",
    "Coordinate with AGM or Lead Server to review reservation notes and create a general seating arrangement for reservations.",
    "Wipe down phone and iPad, make sure it remains charged.",
  ],
  Closing: [
    "Wipe down all menus and make sure the inserts aren’t stained or dirty.",
    "Use glass cleaner to clean the fireplace glass and the wine coolers.",
    "Take out the host stand garbage and replace the liner.",
    "Wipe down the host stand, iPad, and phone.",
    "Sweep the area around the host stand.",
    "Make sure host stand is tidy and neat before checking with manager before leaving.",
  ],
  };
