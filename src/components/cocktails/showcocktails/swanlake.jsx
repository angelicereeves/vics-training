...
const swanLakeCocktails = [
  {
    name: "Black Swan",
    recipe: [
      "1.5 oz Citron Vodka, ",
      "0.5 oz Lemon Juice, ",
      "1 oz Shimmery Black Simple Syrup, ",
      "0.5 oz Triple Sec"
    ],
    method: "Shake and strain into a Martini glass. Garnish: Peninsula Cherry, White Sugar Rim. Ice: None",
  },
  {
    name: "Prince Siegfried",
    recipe: [
      "1.5 oz Flecha Azul Tequila, ",
      "0.5 oz Triple Sec, ",
      "0.5 oz Lemon Juice, ",
      "0.5 oz Lime Juice, ",
      "0.5 oz Strawberry Puree"
    ],
    method: "Shake and dirty dump into a Double Old Fashioned glass. Garnish: Red Sugar Rim. Ice: Cubes",
  },
  {
    name: "Odette's Spell",
    recipe: [
    ...
    method: "Shake and strain into a Coupe glass. Garnish: Chocolate Stick and Grind. Ice: None",
  }
];
...
export default function SwanLakeCocktails() {
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center space-y-10">
        ...
        <p className="text-lg font-mono font-bold text-emerald-100">
            Experience the magic of Swan Lake with these enchanting cocktails.
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-12 text-left">
          {swanLakeCocktails.map((cocktail, index) => (
            <div
              key={index}
